...
public class Verify_All_header extends Pojo  {
	...
	public void verifyTimeTrack()
	{
		...
		soft.assertEquals(title,"actiTIME - Enter Time-Track", "Wrong  title");
		soft.assertAll();

	}
	@Test(priority=4)
	public void verifyWorkscheduleButton()
	{
		testID="P105";
		soft=new SoftAssert();
		System.out.println("Verify WorkscheduleButton");
